...
from app.evaluation import load_eval_cases, load_investigation_eval_cases, load_rag_eval_cases
...
def test_eval_summary_endpoint_returns_deterministic_report() -> None:
    ...
    assert payload["totals"]["total_cases"] == analyze_count + investigate_count + rag_count
